...
site/index_%_compiled.js: src/js/words_%.js src/js/index_%.js $(INDEXJS:%=src/js/%) 
	$(COMPILEJS) --create_source_map site/app_$*_compiled.map --js_output_file $@ $<
	echo '//# sourceMappingURL=/app_$*_compiled.map' >> $@
...
site/index_en_ie_compiled.js: src/js/words_en_ie.js src/js/index_en_ie.js $(INDEXJS:%=src/js/%) src/js/externs.js
site/index_en_us_compiled.js: src/js/words_en_us.js src/js/index_en_us.js $(INDEXJS:%=src/js/%) src/js/externs.js
site/index_es_es_compiled.js: src/js/words_es_es.js src/js/index_es_es.js $(INDEXJS:%=src/js/%) src/js/externs.js
site/index_es_mx_compiled.js: src/js/words_es_mx.js src/js/index_es_mx.js $(INDEXJS:%=src/js/%) src/js/externs.js
site/index_fr_fr_compiled.js: src/js/words_fr_fr.js src/js/index_fr_fr.js $(INDEXJS:%=src/js/%) src/js/externs.js
