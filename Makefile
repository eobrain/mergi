...
modules: site/common.js site/debug.js site/deck.js site/card_es_mx.js site/main.js site/search_url.js site/words_es_mx.js site/shared.js

words: lint data/words.csv node/fetch_words.js node/scrape.js
	node node/fetch_words.js > site/src/words_es_mx.js
	npx standard --fix site/src/words_es_mx.js
